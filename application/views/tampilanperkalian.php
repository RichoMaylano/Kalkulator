...
<head>
    ...
    <link href="<?php echo base_url("/assets/footermain.css"); ?>" type="text/css" rel="stylesheet">
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                <form name='form1' action="<?php echo base_url('Perkalian/perkalian') ?>" method="post" enctype="multipart/form-data">
